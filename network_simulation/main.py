...
def run_simulation():
    ...
    export_topology(G)   # overwrites topology.json fresh each run
    print("[INFO] Topology generated ✓")
    ...
    while True:
        ...
        yield df   # ← KEY: makes this a generator for api.py

        time.sleep(0.8)   # reduced so thread exits cleanly within join(timeout=5)
...
if __name__ == "__main__":
    ...
    try:
        for df in run_simulation():
            pass   # all output handled by prints inside run_simulation
